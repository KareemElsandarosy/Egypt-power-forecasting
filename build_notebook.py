 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "### EDA Insights\n",
    "\n",
    "1. **Outliers:** Low outlier percentage indicates clean data. Positive skewness confirms occasional extreme peaks during hot summer hours.\n",
    "2. **Correlation:** Strong correlation between Lag_1h and current load validates temporal inertia of electricity demand.\n",
    "3. **Temperature:** CDH (Cooling Degree Hours) correlation justifies its inclusion as a key feature for cooling-driven demand.\n",
    "4. **Seasonal:** Summer shows highest demand due to AC load. Winter shows moderate increase from heating.\n",
    "5. **Hourly:** Peak demand occurs 18:00-22:00 (evening). Lowest demand at 02:00-06:00.\n",
    "\n",
    "---"
   ]
  },
...
with open('Egypt_Power_Forecasting.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, ensure_ascii=False, indent=1)

print("[SUCCESS] Notebook generated: Egypt_Power_Forecasting.ipynb")
